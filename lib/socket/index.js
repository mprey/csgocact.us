...
module.exports = function(io) {
  ...
  io.on('connection', function(socket) {
    ...
    io.emit(socket_outgoing.UPDATE_ONLINE, {
    ...
    /* Main Socket Handler */
    require('./main-router')(socket, io, helper);

    /* Settings Handler */
    require('./settings')(socket, io, helper);

    /* Chat Handler */
    require('./chat')(socket, io, helper);

    /* Deposit Handler */
    require('./deposit')(socket, io, helper);

    /* Ban/Mute/Unban/Unmute Handler */
    require('./punishment')(socket, io, helper);

    /* Coinflip Handler */
    require('./games/coinflip')(socket, io, helper);
