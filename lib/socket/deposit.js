...
var socket_incoming = {
  ...
  DEPOSIT_SUCCESS: 'DEPOSIT_OUT_DEPOSIT_SUCCESS',
  DEPOSIT_FAILED: 'DEPOSIT_OUT_DEPOSIT_FAILED'
};

module.exports = function(socket, io, _) {

  socket.on(socket_incoming.DEPOSIT_SUCCESS, (data) => {

  });

  socket.on(socket_incoming.DEPOSIT_FAILED, (data) => {
